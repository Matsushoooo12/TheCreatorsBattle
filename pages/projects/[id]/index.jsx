    ...
    <Flex direction="column" py="56px" px="80px">
        <Flex w="100%" bg="white" p="24px" borderRadius="lg" direction="column">
            ...
            <Flex alignItems="center" mb="8px">
                <Text fontSize="12px" fontWeight="bold" borderRadius="md" p="4px 12px" bgGradient={gradientColor()} mr="8px">{statusText()}</Text>
                <Text fontWeight="bold" fontSize="12px" color="gray.400">{projectItem2.categories?.map((c, index) => index === 0 ? c : `・${c}`)}</Text>
            </Flex>
            <Heading color="blue.800" fontSize="22px" mb="32px">{projectItem2.title}</Heading>
