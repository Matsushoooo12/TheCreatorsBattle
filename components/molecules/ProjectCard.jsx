  ...
  return (
        <Flex w="328px" h="100%" bg="white" borderRadius="2xl" direction="column" boxShadow="lg">
            <Flex w="100%" h="180px" borderTopRightRadius="2xl" position="relative">
                ...
                <Text position="absolute" top="16px" left="0" bgGradient={gradientColor()} color="white" p="4px 12px" fontSize="12px" fontWeight="bold" borderTopRightRadius="md" borderBottomRightRadius="md">{statusText()}</Text>
            </Flex>
            <Flex w="100%" p="8px 16px 16px" direction="column">
                ...
                <Flex w="33%" direction="column" alignItems="center" justifyContent="center">
                    ...
                    <Text fontWeight="bold" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" bgClip="text">{joinNumber}人</Text>
                </Flex>
                <Flex w="33%" direction="column" alignItems="center" justifyContent="center">
                    <Text fontSize="12px">💰 獲得ポイント</Text>
                    <Text fontWeight="bold" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" bgClip="text">{acquisitionPoints}pt</Text>
                </Flex>
                <Flex w="33%" direction="column" alignItems="center" justifyContent="center">
                    <Text fontSize="12px">💣 残り</Text>
                    <Text fontWeight="bold" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" bgClip="text">{untilTheDeadline}日</Text>
                </Flex>
                </HStack>
            </Flex>
        </Flex>
