  ...
  return (
    ...
    >
      ...
      {URL === 'http://localhost:3000/projects' && (
        <Flex direction="column">
          <Flex w="328px" direction="column">
            ...
            <Flex bgGradient="linear(to-b, #7CAAFF, #8D85F4)" alignItems="center" justifyContent="space-between" p="8px 16px" borderRadius="lg" color="white" mb="32px">
      ...
      {URL === `http://localhost:3000/users/${id}` && (
        <Flex direction="column">
          <Flex w="328px" direction="column">
            <Flex w="100%" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" borderRadius="2xl" direction="column" p="12px 16px" mb="16px">
      ...
      {URL === `http://localhost:3000/projects/${id}` && (
        <Flex direction="column">
          <Flex w="328px" direction="column" mb="56px">
            <Text mb="8px" cursor="pointer" color="white" borderRadius="md" boxShadow="lg" fontWeight="bold" w="100%" py="14px" textAlign="center" bgGradient={gradientColor()}>{`${projectButtonText()} >`}</Text>
            <Text fontSize="12px" fontWeight="bold">💸 ️参加するのに、80pt必要です</Text>
          </Flex>
          <Flex direction="column" mb="16px">
            <Text fontWeight="bold">💣 募集終了まで残り</Text>
            <Flex alignItems="flex-end" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" bgClip="text">
          ...
          <HStack spacing="4px" mb="4px">
              <Center w="32px" h="32px" bgGradient="linear(to-b, #7CAAFF, #8D85F4)" borderRadius="full" >
